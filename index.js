...
btn2.addEventListener("click", () => {
  ...
  if (para.classList.contains("d-none")) {
    ...
    para.innerHTML =
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus quos harum ut sint tempora debitis ex et laborum, deserunt inventore id odio esse.";
...
btn3.addEventListener("click", () => {
  ...
  deleteBtn.addEventListener("click", () => {
    listGroup.removeChild(createLi);
  });
